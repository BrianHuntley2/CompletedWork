...
public class Billing {
	...
	public static final String CUSTOMER_FILE = "Billing.customersFile";
	public static final String INVOICE_FILE = "Billing.invoicesFile";
	...
	public Billing(com.amica.escm.configuration.api.Configuration config) {
		this(config.getString(CUSTOMER_FILE), config.getString(INVOICE_FILE));
	}
